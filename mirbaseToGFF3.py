...
annotation = gffpd.read_gff3("/mnt/new_groups/vaksler_group/Isana_Tzah/Charles_seq/mirbase_data/cel_mirbase.gff3")
gff = annotation.df

hairpin = SeqIO.parse(open("/mnt/new_groups/vaksler_group/Isana_Tzah/Charles_seq/mirbase_data/animalsHairpin.fa"),
                        'fasta')
hairpin_dict = SeqIO.to_dict(hairpin)

mature = SeqIO.parse(open("/mnt/new_groups/vaksler_group/Isana_Tzah/Charles_seq/mirbase_data/animalsMature.fa"),
                        'fasta')
