...
input_excel = Path(f"/groups/vaksler_group/Isana_Tzah/Charles_seq/Ziv_Features/all_remaining_after_ziv_{SPECIES}.xlsx")
...
for library_folder in os.listdir(base_dir):
    ...
    # output_dir = "/groups/vaksler_group/Isana_Tzah/Charles_seq/Hofstenia/miRge_output/processing_results/"
