...
xls = pd.ExcelFile("/groups/vaksler_group/Isana_Tzah/Charles_seq/Ziv_Features/all_remaining_after_ziv_Elegans.xlsx")
elegans_sheet_dict = {sheet_name: xls.parse(sheet_name) for sheet_name in xls.sheet_names}

xls = pd.ExcelFile("/groups/vaksler_group/Isana_Tzah/Charles_seq/Ziv_Features/all_remaining_after_ziv_Macrosperma.xlsx")
macrosperma_sheet_dict = {sheet_name: xls.parse(sheet_name) for sheet_name in xls.sheet_names}

xls = pd.ExcelFile("/groups/vaksler_group/Isana_Tzah/Charles_seq/Ziv_Features/all_remaining_after_ziv_Sulstoni.xlsx")
...
#elegans = pd.read_excel("/groups/vaksler_group/Isana_Tzah/Charles_seq/Ziv_Features/all_remaining_after_ziv_Elegans.xlsx", sheet_name="(D) Structural Features")
# macrosperma = pd.read_excel("/groups/vaksler_group/Isana_Tzah/Charles_seq/Ziv_Features/all_remaining_after_ziv_Macrosperma.xlsx", sheet_name="(D) Structural Features")
# sulstoni = pd.read_excel("/groups/vaksler_group/Isana_Tzah/Charles_seq/Ziv_Features/all_remaining_after_ziv_Sulstoni.xlsx", sheet_name="(D) Structural Features")
...
save_back_to_all(elegans_sheet_dict, "/groups/vaksler_group/Isana_Tzah/Charles_seq/Ziv_Features/all_remaining_after_ziv_Elegans.xlsx")
save_back_to_all(macrosperma_sheet_dict, "/groups/vaksler_group/Isana_Tzah/Charles_seq/Ziv_Features/all_remaining_after_ziv_Macrosperma.xlsx")
save_back_to_all(sulstoni_sheet_dict, "/groups/vaksler_group/Isana_Tzah/Charles_seq/Ziv_Features/all_remaining_after_ziv_Sulstoni.xlsx")
# # Save to original all candidates files
...
#
# # Save the changes back to the same sheet
# with pd.ExcelWriter("/groups/vaksler_group/Isana_Tzah/Charles_seq/Ziv_Features/all_remaining_after_ziv_Elegans.xlsx", engine='openpyxl') as writer:
#     writer.book = writer.book  # Needed for openpyxl compatibility
#     writer.sheets = {ws.title: ws for ws in writer.book.worksheets}
#     # elegans.to_excel(writer, "(D) Structural Features", index=False)
