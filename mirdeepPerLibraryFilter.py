...
from pipeline_config import DEFAULT_NCRNA_DIR, EXCLUDE_C_DEFAULT, FILTER_MC_DEFAULT, LOW_SCORE_TOTAL_DEFAULT
...
def run(inputs, threshold_tp, threshold_s, threshold_mc, exclude_c, ncrna_dir=NCRNA_DIR):
    f"""
    ...
    """
    filtered_input, removed_input = filterInputs(
        inputs, threshold_s, threshold_tp, threshold_mc, exclude_c, ncrna_dir=ncrna_dir
    )
...
if __name__ == '__main__':
    ...
    threshold_tp = None
    threshold_s = None
    threshold_mc = FILTER_MC_DEFAULT
    exclude_c = EXCLUDE_C_DEFAULT
    ncrna_dir = NCRNA_DIR
    args = []
    ...
    run(inputs, threshold_tp, threshold_s, threshold_mc, exclude_c, ncrna_dir=ncrna_dir)
