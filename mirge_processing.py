...
for library_folder in os.listdir(base_dir):
    ...
    with open(gff_file_path, 'r') as f:
        ...
        for line in f:
            ...
            attributes = dict(item.split('=') for item in parts[-1].split(';'))
    ...
    # output_dir = "/sise/vaksler-group/IsanaRNA/Isana_Tzah/Charles_seq/Hofstenia/miRge_output/processing_results/"
...
final_output_filename = os.path.join(output_dir, 'final_miRNA_isomiR_report.csv')
