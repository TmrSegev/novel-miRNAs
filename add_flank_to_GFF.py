...
variant = args.variant or ("new_genome" if args.new_genome else None)
cfg = get_species_config(args.species, args.base_path, variant=variant)
base_dir = cfg["scripts_dir"]
species_prefix = cfg["display_species"]
